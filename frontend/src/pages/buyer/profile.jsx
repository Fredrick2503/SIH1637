      ...
      <section className="mt-[80px] h-fit pb-[60px] ">
        ...
        <section className=" w-[100%] grid md:grid-cols-3 gap-2 p-3" >
          <article className="w-[100%] shadow-[0px_0px_5px_rgba(0,0,0,0.19)] md:col-span-2 p-4 rounded-xl ">
            ...
            <p>
              {userData.about || "No business description provided. Share your vision and requirements with the community!"}
            </p>
          </article>
          <article className="shadow-[0px_0px_5px_rgba(0,0,0,0.19)] rounded-xl p-4 w-full " >
            <h1 className=" text-xl font-semibold mb-4" >Buyer Stats</h1>
            ...
            <table className="w-full text-sm ">
              <tbody>
                ...
                <tr className="border-b border-gray-100">
                  <td className="py-2">Active Bids</td>
                  <td className="text-right font-medium">{activeBids}</td>
                </tr>
              </tbody>
            </table>
          </article>
          <article className="shadow-[0px_0px_5px_rgba(0,0,0,0.19)] rounded-xl p-4 md:col-span-3 w-full " >
            <h1 className=" text-xl font-semibold mb-2 " >My Recent Bids</h1>
                ...
                <tbody>
                  {bids.slice(0, 5).map((bid) => (
                    <tr key={bid.id} className="border-b">
                      ...
                      <td className="py-2 px-4">{bid.seller_name || "Producer"}</td>
                  ...
                  {bids.length === 0 && (
                    <tr>
                      <td colSpan="5" className="py-4 text-center text-gray-500">No bids placed yet</td>
                    </tr>
                  )}
                </tbody>
              </table>
...
const Hero = ({ userData }) => {
  const heroImage = userData?.heroImg 
    ...
    : "https://sugarandcream.co/wp-content/uploads/2020/04/pic6-6.jpg";

  return (
    <section className="w-screen bg-[linear-gradient(to_top,rgba(0,0,0,0.5),rgba(0,0,0,0.25),rgba(0,0,0,0))] bg-blend-soft-light bg-center bg-no-repeat bg-cover h-min-fit pt-[200px] relative">
      ...
      <article className=" w-fit px-6 py-5 flex flex-col gap-1">
        ...
        <p className="text-sm text-white font-light">
          {userData.tagline || "Committed to sourcing premium quality produce"}
        </p>
