...
export default function NotFound() {
  ...
  >
    ...
    <div className=" h-[calc(100%-80px)] w-full mt-[80px]  overflow-y-auto bg-gray-300 relative ">
      <p className='text-3xl font-medium text-center mt-10 md:mt-20 mx-3' >404 - Page Not Found</p>
      <p className=' text-sm md:text-xl font-normal text-center mt-6 mx-3 text-gray-700' >The page you're looking for doesn't exist. It might have been moved or deleted.</p>
    <Spline
